...
**Note: User need to verify email to login.**

### GET /api/verify/:verificationToken

- **Description**: Verify user email.
- **Parameters**:
  - `verificationToken` (required): The verification token of the user.
- **Response**:
  - `200 OK`: User verified successfully.
  - `401 Unauthorized`: Invalid verification token.
  - `404 Not Found`: User not found.
  - `500 Internal Server Error`: An error occurred while verifying the user.
...
- **Response**:
  ...
  - `404 Not Found`: User not found.
  - `500 Internal Server Error`: An error occurred while sending the verification email.
